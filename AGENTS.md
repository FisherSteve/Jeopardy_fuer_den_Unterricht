...
- Optionale Musik: GitHub-Pages-Spiele laden die gemeinsame Jeopardy-theme-song.mp3 aus dem Hauptordner. Lokale und im Spiel-Ersteller erzeugte Spiele suchen sie neben ihrer HTML. Nicht einbetten oder automatisch mit herunterladen; nach Freigabe im Menü erst beim Öffnen einer Frage laden und von vorne starten. Beim Aufdecken, Abgeben oder Schließen stoppen; Freigabe für die nächste Frage erhalten. Fehlende Datei ist erlaubt; beim Tabwechsel stoppen.
